...
export const CAMPAIGN_DEADLINE = new Date('2025-12-01T05:59:59Z'); // 23:59 h del 30 de noviembre en Querétaro (UTC-06)
export const CAMPAIGN_TIMEZONE = 'America/Mexico_City';
export const CAMPAIGN_TIMEZONE_LABEL = 'Querétaro (UTC−06:00)';
