  ...
  return (
    <header className="bg-white/90 backdrop-blur fixed top-0 inset-x-0 z-40 border-b border-neutral-200 dark:bg-neutral-900/70 dark:border-neutral-800">
      <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3">
        <a href="#" className="flex items-center font-display text-2xl text-primary">
          Sesiones Navideñas
        </a>
        ...
        <nav className="hidden md:flex gap-6 font-medium text-sm">
          ...
          <a href="#reserva" className="ml-4 inline-flex items-center bg-primary text-white px-4 py-2 rounded-md hover:bg-primary-dark transition-colors">
            Apartar mi lugar
          </a>
        </nav>
      ...
      {isOpen && (
        <div className="md:hidden bg-white dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700">
          <div className="px-4 py-4 space-y-2">
            <a href="#incluye" className="block hover:text-primary" onClick={() => setIsOpen(false)}>Qué incluye</a>
            <a href="#cómo-funciona" className="block hover:text-primary" onClick={() => setIsOpen(false)}>Cómo funciona</a>
            <a href="#testimonios" className="block hover:text-primary" onClick={() => setIsOpen(false)}>Testimonios</a>
            <a href="#faq" className="block hover:text-primary" onClick={() => setIsOpen(false)}>FAQ</a>
            <a href="#reserva" className="block mt-2 bg-primary text-white text-center px-4 py-2 rounded-md hover:bg-primary-dark" onClick={() => setIsOpen(false)}>
              Apartar mi lugar
            </a>
          </div>
        </div>
